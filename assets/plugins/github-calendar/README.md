...
<script>
    ...
    GitHubCalendar(".calendar", "zeeshan-mehdi", { responsive: true });

    // Use a proxy
    GitHubCalendar(".calendar", "zeeshan-mehdi", { proxy (username) { return fetch(`https://your-proxy.com/github?user=${username}`).then(r => r.text()) });
</script>
```
